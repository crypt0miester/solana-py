...
from construct import Byte, Bytes, Int32ul, Int64ul
...
_CREATE_LAYOUT = cStruct(
    "hashed_name_size" / Int32ul, "hashed_name" / Bytes(32), "lamports" / Int64ul, "space" / Int32ul
)

_UPDATE_LAYOUT = cStruct("offset" / Int32ul, "size" / Int32ul, "input_data" / Bytes(this.size))

_TRANSFER_LAYOUT = cStruct("new_owner" / PUBLIC_KEY_LAYOUT)
